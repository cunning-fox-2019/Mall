 ...
 */
public class BuyBdAdapter extends BaseQuickAdapter<GoodsItemEntity, BaseViewHolder> {
    public BuyBdAdapter(int layoutResId, @Nullable List<GoodsItemEntity> data) {
