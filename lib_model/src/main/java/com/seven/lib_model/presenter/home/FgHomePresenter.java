...
public class FgHomePresenter extends BasePresenter<IBaseView,BaseFragment> {
    ...
    public void commodityList(int requestCode,String page) {
        ...
        if (rxObserver == null)
            return;
        HttpRxObservable.getObservable(RequestHelper.getInstance().commodityList(jsonStr), null, FragmentEvent.PAUSE).subscribe(rxObserver);
    }
